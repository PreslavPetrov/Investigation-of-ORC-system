...
legend('50% Load', '75% Load','85% Load','100% Load','Location','southwest');                      % Legend
...
legend('50% Load', '75% Load','85% Load','100% Load','Location','northwest');                       % Legend
xlabel('Upper cycle pressure of ORC system [bar]');                            % x-axis label
...
legend('50% Load', '75% Load','85% Load','100% Load','Location','southeast');                       % Legend
xlabel('Upper cycle pressure of ORC system [bar]');                            % x-axis label
