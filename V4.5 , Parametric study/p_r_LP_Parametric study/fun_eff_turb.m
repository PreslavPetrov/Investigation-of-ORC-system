function [Eff_tg] = fun_eff_turb(p_r_UP_bar,p_r_Cond_bar,L_tg_rated,El_load_est,t_r_ev_o)
...
if(p_r_Cond_bar >= 0.075) 
  f_bpcf = 1;
else
    f_bpcf  = 0;
    for i =1:1:n+1
     f_bpcf = f_bpcf + Poly_f_bpcf(i)*(p_r_Cond_bar)^(n-i+1);
    end   
end
