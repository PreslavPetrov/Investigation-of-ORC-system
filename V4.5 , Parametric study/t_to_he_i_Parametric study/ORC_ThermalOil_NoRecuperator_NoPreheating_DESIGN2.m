...
Refrigerant = 'R245fa' 
L_tg_rated = 400;   % Rated Genrator power [kW] 
...
t_to_he_i_max = 135 ;
profress = 0;
for t_to_he_ii = t_to_he_i_min:5:t_to_he_i_max
l = l+1;
xx(l) = t_to_he_ii;
t_to_he_i = [t_to_he_ii, t_to_he_ii, t_to_he_ii, t_to_he_ii];  
...
profress = ((t_to_he_ii-t_to_he_i_min)/(t_to_he_i_max-t_to_he_i_min)*100
end
...
grid on
title('t_to_he_i against various t_to_he_i_n_i_t');       % Title
legend('50% Load', '75% Load','85% Load','100% Load');                      % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                           % x-axis label
...
grid on
title('t_s_wcond_o against various t_to_he_i_n_i_t ');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
...
grid on
title('t_e_go against various t_to_he_i_n_i_t ');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
...
grid on
title('t_t_ohe_o against various t_to_he_i_n_i_t ');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
...
grid on
title('mfr_t_obp against various t_to_he_i_n_i_t ');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
...
grid on
title('mfr_t_o_ev against various t_to_he_i_n_i_t ');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
...
grid on
title('Q_h_e against various t_to_he_i_n_i_t ');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
...
grid on
title('Q_e_v  against various t_to_he_i_n_i_t ');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
...
grid on
title('P_e_l  against various t_to_he_i_n_i_t ');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]]');                            % x-axis label
...
grid on
title('P_n_e_t  against various t_to_he_i_n_i_t ');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
...
plot (xx,ply10(1,:),'-r',xx,ply10(2,:),'-g',xx,ply10(3,:),'-b',xx,ply10(4,:),'--');
grid on
title('eff_t_u_r_bis  against t_to_he_i_n_i_t');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
...
plot (xx,ply10(1,:),'-r',xx,ply10(2,:),'-g',xx,ply10(3,:),'-b',xx,ply10(4,:),'--');
grid on
title('eff_t_u_r_bm  against t_to_he_i_n_i_t');      % Title
legend('50% Load', '75% Load','85% Load','100% Load');                       % Legend
xlabel('t_to_he_i_n_i_t [Degrees C]');                            % x-axis label
ylabel('eff_t_u_r_bm , Mechanical Turbine-Generator efficiency [-] ');                                              % y-axis label

csvwrite('out_ORC_opt3.txt',out_ORC_opt)